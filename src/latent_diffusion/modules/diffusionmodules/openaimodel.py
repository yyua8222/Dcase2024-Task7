...
class UNetModel(nn.Module):
                    ...
                    #     ipdb.set_trace()
                        layers.append(
                            ...
                            if not use_spatial_transformer
                                ...
                                context_dim=context_dim[context_dim_id]  # 1024
                            )
                        )
    ...
    def forward(self, x, timesteps=None, y=None, context_list=None, context_attn_mask_list=None, **kwargs):
        ...
        # print(f"y is {y} and numclase is {self.num_classes} and extra is {self.extra_film_condition_dim}")
        # ipdb.set_trace()
        ...
        for module in self.input_blocks:
            newh = h
            # ipdb.set_trace()#   shape for first spacila transforemr is torch.Size([1, 128, 128, 8])
